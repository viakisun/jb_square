<script lang="ts">
	...
	const SOURCE_ID = 'source:news:mohw';
...
<div class="page">
	<div class="page-header">
		<div>
			<h1 class="page-title">보건복지부 뉴스</h1>
			<p class="page-subtitle">보건복지부 RSS 뉴스 크롤링 및 관리</p>
		</div>
