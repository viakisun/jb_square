<script lang="ts">
	/**
	 * 지자체 사업공고 페이지 (JBTP Business Notices)
	 * JBTP 사업공고 크롤링 + 게시된 공고 관리
	 */
...
<svelte:head>
	<title>지자체 사업공고 - JB SQUARE</title>
</svelte:head>

<div class="page">
	<div class="page-header">
		<div>
			<h1 class="page-title">지자체 사업공고</h1>
			<p class="page-subtitle">JBTP 사업공고 크롤링 및 관리</p>
		</div>
