        ...
        <div className="space-y-4 mb-6">
          {centers.map((center) => (
            <Link
              ...
              className="block p-4 bg-white border border-gray-200 rounded-lg hover:shadow-lg hover:border-blue-300 transition-all duration-200 group"
            >
              <div className="flex items-start justify-between">
                ...
                {center.vacant_rooms && center.vacant_rooms !== '0' && (
                  <div className="ml-4 flex-shrink-0">
                    <div className="px-4 py-2 bg-green-50 border border-green-200 rounded-lg group-hover:bg-green-100 transition-colors">
