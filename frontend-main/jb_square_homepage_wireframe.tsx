        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border-2 border-gray-300 p-6 bg-gray-50">
              <div className="w-12 h-12 bg-gray-300 border-2 border-gray-400 mb-4 flex items-center justify-center text-xs">
                ICON
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white border-2 border-gray-400 p-6">
            <div className="flex justify-between items-center mb-6 border-b-2 border-gray-300 pb-4">
              ...
              <div className="border border-gray-400 px-4 py-2 text-gray-600">
                [LINK] 전체 보기 →
              </div>
            </div>
              ...
              <div className="border-2 border-gray-300 p-4 bg-gray-50">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right text-sm text-gray-500 flex-shrink-0 ml-4 border border-gray-300 p-2">
                    ...
                    <div className="border border-gray-400 bg-gray-200 px-2 py-1 font-semibold">
                      [STATUS] 모집중
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            <div className="text-center border-2 border-gray-400 p-6 bg-gray-50">
              <div className="text-4xl font-bold text-gray-800 mb-2 border-b border-gray-300 pb-2">
                [NUMBER] 34
              </div>
              ...
              <div className="space-y-4">
                <div className="border-2 border-gray-300 p-4 bg-gray-50">
                  ...
                  <div className="text-gray-600 text-sm mb-2 border border-gray-300 p-2">
                    [DESCRIPTION] 세계적인 바이오 기업들의 투자 러시가
                    이어지며...
                  </div>
                  <div className="text-xs text-gray-400 border-t border-gray-300 pt-2">
                    [DATE] 2024-09-15
                  </div>
                </div>
                <div className="border-2 border-gray-300 p-4 bg-gray-50">
              ...
              <div className="space-y-4">
                <div className="border-2 border-gray-300 p-4 bg-gray-50">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="border border-gray-400 bg-gray-200 px-2 py-1 text-xs font-medium">
                      [TAG] 컨퍼런스
                    </div>
                  </div>
                  <div className="text-gray-600 text-sm mb-2 border border-gray-300 p-2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border-2 border-gray-400 p-6 bg-gray-50">
              <div className="w-16 h-16 bg-gray-300 border-2 border-gray-400 mb-4 flex items-center justify-center text-xs">
                LOGO
              </div>
              ...
              <div className="flex justify-between text-xs">
                <div className="border border-gray-400 bg-gray-200 px-2 py-1">
                  [FIELD] 바이오의약품
                </div>
                <div className="border border-gray-400 bg-gray-200 px-2 py-1">
                  [STAGE] 상장기업
