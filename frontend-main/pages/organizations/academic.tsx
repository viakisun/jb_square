...
const AcademicPage = () => {
  ...
  const universities = [
    ...
    },
    {
      ...
      bioDepartments: ["생명과학과", "생명공학과", "의생명공학과"],
    },
    {
      name: "군산대학교",
      type: "국립대",
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border border-gray-300 p-3 bg-white">
                          ...
                          <div className="text-gray-600">
                            [VALUE] {major.industryCooperation}
                          </div>
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {major.researchAreas.map((area, areaIndex) => (
                          <div
                            key={areaIndex}
                            className="border border-gray-300 p-2 bg-white text-sm"
                          >
                            [FIELD] {area}
                          </div>
                        ))}
