  ...
  const recentActivities = [
    {
      ...
      title: "2024년 9월 정례회의",
      content:
        "글로벌 바이오시밀러 시장 동향 및 전북 바이오 클러스터 발전 방안 논의",
        ...
        <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 전북 바이오 클러스터 내 기업 CEO들 간의
                      네트워킹 강화와 정보 공유를 통해 상호 발전과 협력을
                      도모하고, 전북 바이오 산업의 경쟁력 향상에 기여
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
                    <div className="font-medium text-gray-800 mb-2">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 전북을 글로벌 바이오 허브로 발전시키고, 회원
                      기업들의 지속적인 성장과 혁신을 지원하는 최고의 CEO
                      네트워크 구축
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="border-2 border-gray-300 p-4 bg-gray-50">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="border-l-2 border-gray-400 pl-3">
                      • 글로벌 바이오 시장 트렌드
                    </li>
                    <li className="border-l-2 border-gray-400 pl-3">
                      • 신약 개발 동향
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="border-2 border-gray-400 p-6 bg-gray-50">
                <h3 className="text-xl font-semibold mb-4 text-gray-800">
                  [SUBSECTION] 단기 계획 (2024년 하반기)
                </h3>
                <div className="space-y-3">
                  <div className="border border-gray-300 p-3 bg-white">
                    <div className="font-medium text-gray-800">
                      [PLAN] 글로벌 바이오 투자자 초청 세미나
                    </div>
                    <div className="text-gray-600 text-sm">
                      [DATE] 2024년 10월
                    </div>
              ...
              <div className="border-2 border-gray-400 p-6 bg-gray-50">
                <h3 className="text-xl font-semibold mb-4 text-gray-800">
                  [SUBSECTION] 중장기 계획 (2025년)
                </h3>
                <div className="space-y-3">
                  <div className="border border-gray-300 p-3 bg-white">
                    <div className="font-medium text-gray-800">
                      [PLAN] 해외 바이오 클러스터와의 MOU 체결
                    </div>
                    <div className="text-gray-600 text-sm">
                      [TARGET] 미국, 유럽 클러스터
                    </div>
