                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 신약 개발 분야의 전문가들이 모여 서로의
                      경험과 지식을 공유하고 네트워크를 구축
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
                    <div className="font-medium text-gray-800 mb-2">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 신약 개발의 각 단계별 노하우와 최신 동향을
                      공유하여 전체적인 역량 향상
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 기업 간, 기관 간 협력 기회를 발굴하고 공동
                      프로젝트 추진
                    </div>
                  </div>
                </div>
