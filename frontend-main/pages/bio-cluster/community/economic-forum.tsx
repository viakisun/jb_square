                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      ...
                      종합적인 경제 포럼으로, 바이오, IT, 제조업 등 전 산업에
                      걸친 협력과 발전을 추진
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 바이오와 IT, 제조업과 서비스업 등 다양한
                      산업 간 융합을 통한 새로운 성장동력 발굴
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border border-gray-300 p-3 bg-white">
                          ...
                          <div className="text-gray-600">
                            [VALUE] {institute.researchAreas.join(", ")}
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="border-2 border-gray-400 p-6 bg-gray-50">
                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 p-4 bg-white">
                    <div className="font-medium text-gray-800 mb-2">
                      [ACTIVITY] 월례 경제동향 세미나
                    </div>
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 매월 첫째 주 금요일, 전북 경제 동향 분석 및
                      전망
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
              ...
              <div className="border-2 border-gray-400 p-6 bg-gray-50">
                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 p-4 bg-white">
                    ...
                    <div className="text-gray-600 text-sm">
                      [DESCRIPTION] 바이오, IT, 제조업 등 산업별 전문 워킹그룹
                      운영
                    </div>
                  </div>
                  <div className="border border-gray-300 p-4 bg-white">
