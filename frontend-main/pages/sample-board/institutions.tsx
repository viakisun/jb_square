...
export default function InstitutionNoticesPage() {
  ...
  return (
    <>
      <Head>
        <title>유관 기관 공고 - JB SQUARE</title>
        <meta name="description" content="R&D 유관 기관의 연구개발 지원 공고" />
      </Head>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  R&D 유관 기관의 연구개발 지원 공고 (NTIS, BIZINFO 등)
                </p>
              </div>
            </div>
          </div>
              ...
              {displayNotices.length === 0 && (
                <div className="py-20 text-center">
                  <h3 className="text-lg font-semibold text-gray-700 mb-2">
                    {isSearchMode ? '검색 결과가 없습니다' : '등록된 유관 기관 공고가 없습니다'}
                  </h3>
