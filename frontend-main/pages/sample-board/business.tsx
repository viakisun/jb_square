/**
 * 📋 기업 맞춤형 지원 사업 전체 목록 페이지
 *
 * 스타트업 및 중소기업을 위한 맞춤형 지원 사업 공고를 전체 목록으로 보여주는 페이지입니다.
 * source_id='source:bizinfo:api' 필터가 자동으로 적용됩니다.
 *
...
export default function BusinessSupportNoticesPage() {
  ...
  const {
    ...
    source_id: 'source:bizinfo:api',  // 기업 맞춤형 지원 사업만 필터링
    limit: 20,
    sort_order: 'desc'
  });
  ...
  const {
    ...
    additionalFilters: {
      source_id: 'source:bizinfo:api'  // 기업 맞춤형 공고 내에서만 검색
    },
    debounceDelay: 500,
    minLength: 2
  });
  ...
  return (
    <>
      <Head>
        <title>기업 맞춤형 지원 사업 - JB SQUARE</title>
        <meta name="description" content="스타트업 및 중소기업을 위한 맞춤형 지원" />
      </Head>
              ...
              {displayNotices.length === 0 && (
                <div className="py-20 text-center">
                  <h3 className="text-lg font-semibold text-gray-700 mb-2">
                    {isSearchMode ? '검색 결과가 없습니다' : '등록된 기업 맞춤형 지원 사업이 없습니다'}
                  </h3>
