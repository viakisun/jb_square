...
const NewsPage = () => {
  ...
  const newsItems = [
    ...
    },
    {
      ...
      views: 856,
      content:
        "혁신적인 바이오의약품 개발로 주목받는 JB SQUARE 입주기업들이 연이어 임상 승인을 획득했습니다...",
    },
    {
      id: 3,
      ...
      views: 567,
      content:
        "전북도와 주요 투자기관 간 협력 강화를 통한 바이오 투자 생태계 활성화 방안이 논의되었습니다...",
    },
  ];
          ...
          <section className="mb-8">
            <div className="bg-gray-50 border-2 border-gray-300 p-6">
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <button className="border-2 border-gray-400 bg-white p-2">
                  [BUTTON] 검색
                </button>
              </div>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              {newsItems.map((news) => (
                <div
                  key={news.id}
                  className="border-2 border-gray-300 p-6 bg-gray-50"
                >
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center text-xs text-gray-500">
                        <span className="border border-gray-300 px-2 py-1 mr-3">
                          [AUTHOR] {news.author}
                        </span>
                        <span className="border border-gray-300 px-2 py-1 mr-3">
                          [DATE] {news.date}
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-gray-400 p-6 bg-gray-50">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    ...
                    <span className="border border-gray-400 bg-gray-200 px-2 py-1">
                      [TAG] 산업동향
                    </span>
                  </div>
                </div>
                ...
                <div className="border-2 border-gray-300 p-6 bg-white">
                  <div className="prose max-w-none">
                    ...
                    <p className="text-gray-600 mb-4">
                      세계적인 바이오 기업들의 투자 러시가 이어지며 전북 바이오
                      클러스터가 글로벌 바이오 허브로 자리잡고 있습니다. 최근
                      발표된 통계에 따르면 전북 바이오 클러스터의 입주기업 수가
                      전년 대비 30% 증가한 87개로 늘어났으며, 총 투자액도
                      2,300억원을 기록했습니다.
                    </p>
                    <p className="text-gray-600 mb-4">
                      특히 셀트리온, 진바이오텍 등 글로벌 바이오 기업들이 전북을
                      새로운 생산 거점으로 선택하면서 클러스터의 위상이 한층
                      높아지고 있습니다. 이는 전북의 우수한 인력과 인프라,
                      그리고 정부의 적극적인 지원 정책이 결합된 결과로
                      평가됩니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="border border-gray-300 p-4 bg-gray-50">
                  ...
                  <div className="space-y-2">
                    <a
                      href="#"
                      className="block border border-gray-300 p-2 hover:bg-gray-100"
                    >
                ...
                <div className="border border-gray-300 p-4 bg-gray-50">
                  ...
                  <div className="flex space-x-4">
                    <button className="border border-gray-400 px-4 py-2 bg-white">
                      [BUTTON] 페이스북
                    </button>
                    <button className="border border-gray-400 px-4 py-2 bg-white">
                      [BUTTON] 트위터
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border-2 border-gray-300 p-4 bg-gray-50">
                <h3 className="font-semibold mb-2 text-gray-800">
                  [TITLE] "전북 바이오 클러스터, 세계 10위 바이오허브 진입"
                </h3>
                <div className="text-gray-600 text-sm border border-gray-300 p-2">
                  [DESCRIPTION] 글로벌 바이오 클러스터 순위에서 전북이 10위에
                  진입했다는 소식
                </div>
              </div>
              <div className="border-2 border-gray-300 p-4 bg-gray-50">
                <h3 className="font-semibold mb-2 text-gray-800">
                  [TITLE] "셀트리온 바이오시밀러, FDA 승인으로 해외 진출 가속화"
                </h3>
                <div className="text-gray-600 text-sm border border-gray-300 p-2">
                  [DESCRIPTION] 셀트리온의 바이오시밀러가 FDA 승인을 받아 해외
                  진출이 가속화
                </div>
              </div>
              <div className="border-2 border-gray-300 p-4 bg-gray-50">
                <h3 className="font-semibold mb-2 text-gray-800">
                  [TITLE] "전북도, 바이오 스타트업 200개 육성 계획 발표"
                </h3>
                <div className="text-gray-600 text-sm border border-gray-300 p-2">
                  [DESCRIPTION] 전북도가 2025년까지 바이오 스타트업 200개 육성을
                  목표로 발표
                </div>
              </div>
              <div className="border-2 border-gray-300 p-4 bg-gray-50">
                <h3 className="font-semibold mb-2 text-gray-800">
                  [TITLE] "K-바이오 벨트 사업 본격 추진, 5조원 투자 확정"
                </h3>
                <div className="text-gray-600 text-sm border border-gray-300 p-2">
                  [DESCRIPTION] K-바이오 벨트 사업에 5조원 규모의 투자가
                  확정되어 본격 추진
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <div className="flex space-x-2">
                {[1, 2, 3, 4, 5].map((num) => (
                  <button
                    key={num}
                    className="border border-gray-400 px-3 py-2 bg-white"
                  >
                    [PAGINATION] {num}
                  </button>
                ))}
