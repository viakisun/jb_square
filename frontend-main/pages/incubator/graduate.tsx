    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-100 border-2 border-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4 text-gray-800">[HEADER] 졸업기업</h1>
          <p className="text-xl text-gray-600 border border-gray-300 p-2 inline-block">
            [DESCRIPTION] 창업보육센터 졸업기업 현황
          </p>
        </div>
      </section>
      ...
      <main className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="border-2 border-gray-400 p-6 bg-gray-50">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">[SECTION] 졸업기업 현황</h2>
              ...
              <table className="w-full border border-gray-300">
                <thead className="bg-gray-200">
                  <tr>
                    ...
                    <th className="border border-gray-300 p-3 text-left">[TH] 졸업일</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 p-3">[TD] 2021.01</td>
