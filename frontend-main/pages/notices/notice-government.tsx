 ...
 * 정부공고 페이지 컴포넌트
 */
export default function GovernmentNoticePage() {
  /**
   * 검색 모드 상태
  ...
  return (
    <>
      {/* SEO를 위한 페이지 메타데이터 */}
      <Head>
        <title>정부공고 - JB SQUARE</title>
        <meta name="description" content="중앙 정부 각 부처에서 발표하는 바이오 산업 관련 지원 사업 및 공고" />
      </Head>
            ...
            {displayNotices.length === 0 && (
              <div className="py-20 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">
                  {isSearchMode ? '검색 결과가 없습니다' : '등록된 정부공고가 없습니다'}
                </h3>
