...
export default function BusinessNoticePage() {
  ...
  return (
    <>
      {/* SEO를 위한 페이지 메타데이터 */}
      <Head>
        <title>기업마당공고 - JB SQUARE</title>
        <meta name="description" content="예비창업부터 중견기업까지 다양한 성장 단계의 기업을 위한 지원 사업 및 공고" />
      </Head>
      ...
      >
        ...
        <div className="mb-8">
          <SearchBar
            ...
            placeholder="기업마당공고 검색 (제목, 내용, 기관명)"
            size="large"
            ...
            {displayNotices.length === 0 && (
              <div className="py-20 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">
                  {isSearchMode ? '검색 결과가 없습니다' : '등록된 기업마당공고가 없습니다'}
                </h3>
