...
const GovernmentAnnouncementsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {ministries.map((ministry, index) => (
                <div
                  key={index}
                  className="border-2 border-gray-300 p-4 bg-gray-50 text-center"
                >
                  ...
                  <tbody>
                    {announcements.map((announcement) => (
                      <tr key={announcement.id}>
                        ...
                        <td className="border border-gray-300 p-3">
                          [TD] {announcement.deadline}
                        </td>
                        <td className="border border-gray-300 p-3">
                          [TD] {announcement.title}
                        </td>
                        <td className="border border-gray-300 p-3">
                          [TD] {announcement.ministry}
                        </td>
                        <td className="border border-gray-300 p-3">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border border-gray-300 p-2 bg-white">
                      <div className="font-medium text-gray-800">
                        [ATTACHMENT] 신청서 양식.xlsx
                      </div>
                    </div>
                    <div className="border border-gray-300 p-2 bg-white">
                      <div className="font-medium text-gray-800">
                        [ATTACHMENT] 작성 가이드.pdf
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {/* 피드백 메모 섹션 */}
      <FeedbackMemo
        pagePath="/announcements/government"
        pageTitle="정부/지자체 공고"
      />
